...
const ModernVillaCover = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 bg-light-pink'>
        ...
        <Image src={'/images/modern-villa-cover.jpg'} width={1920} height={1080} alt='' className='object-cover min-h-[300px]'></Image>
      

      <div className='py-32 md:py-0 flex flex-col justify-center items-center'>
